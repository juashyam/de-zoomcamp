...
![GCS Bucket - Trip Data Files](screenshots/bucket_trip_files.png)
...
**External Table:** `de-zoomcamp-sandbox-487011.zoomcamp.external_assignment3_yellow_tripdata_2024`

**Materialized Table:** `de-zoomcamp-sandbox-487011.zoomcamp.assignment3_yellow_tripdata_2024_non_partitioned`

**Partitioned & Clustered Table:** `de-zoomcamp-sandbox-487011.zoomcamp.assignment3_yellow_tripdata_2024_partitioned_clustered`
...
#### ANSWER: `It will take 0 B because bigquery uses metadata to answer simple COUNT(*) queries without filters. bigquery only scans the table when we run count(*) with filters.`
